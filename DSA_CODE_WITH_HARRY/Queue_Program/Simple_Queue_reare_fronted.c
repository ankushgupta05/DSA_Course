/* simple Queue program   of an enqueue and  an dequeue Uing pointer  */
...
int main()
{
    struct Queue *q;       // Using poniter
    q->size = 5;
    q->r = q->f = -1;
    // struct Queue *arr = (int *)malloc(q.size * (sizeof(int)));   
...
//  Fuction of dequeue Element 
   ...
   q->r=q->f +1 ;    //  assign value in q->r of q->f  for print All Element Which Rimender in Queue . 
